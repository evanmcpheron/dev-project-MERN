...
const Navbar = ({ auth: { isAuthenticated, loading, isAdmin, user }, logout }) => {
  ...
  const authLinks = (
    <ul>
      <li>
        <Link to="/tutorials" onClick={() => setCount(count === 'closed' ? 'open' : 'closed')}>
          Tutorials
        </Link>
      </li>
      <li>
        <Link to="/posts" onClick={() => setCount(count === 'closed' ? 'open' : 'closed')}>
          Posts
        </Link>
      </li>
      <li>
        <Link to="/profiles" onClick={() => setCount(count === 'closed' ? 'open' : 'closed')}>
          Developers
        </Link>
      </li>
      <li>
  ...
  const adminLinks = (
    <ul>
      <li>
        <Link to="/admin" onClick={() => setCount(count === 'closed' ? 'open' : 'closed')}>
          Admin
        </Link>
      </li>
      <li>
      ...
      <li>
        <p onClick={logout} href="#!">
          <Link to="/" onClick={() => setCount(count === 'closed' ? 'open' : 'closed')}>
            <i className="fas fa-sign-out-alt"></i> Logout
          </Link>
        </p>
      </li>
  ...
  const guestLinks = (
    <ul>
      ...
      <li>
        <Link to="/register" onClick={() => setCount(count === 'closed' ? 'open' : 'closed')}>
          Register
        </Link>
      </li>
      <li>
        <Link to="/login" onClick={() => setCount(count === 'closed' ? 'open' : 'closed')}>
          Login
        </Link>
      </li>
    </ul>
