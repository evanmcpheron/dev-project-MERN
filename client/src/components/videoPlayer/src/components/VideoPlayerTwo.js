      ...
      <div className="VideoPlayerTwo ">
        {this.state.width >= 1200 ? (
          <div>
            <section className="section player-section">
              ...
              <section className="side-playlist">
                {this.props.videos.map((video) => {
                  return (
                    <div key={video._id} className={`playlist-wrapper`}>
            ...
            <h6 className="mt2">{this.props.videos[this.state.currentPosition].title}</h6>
            <a href={this.props.videos[this.state.currentPosition].githubUrl} target="_blank">
              Github Repo
            </a>
            <div className="playlist playlist-bottom">
              <section>
                <CommentForm
                  tutorialId={this.props.videos[this.state.currentPosition]._id}
                  videoId={this.props.tutorial._id}
                />

                {this.props.videos.map((video) => {
                  return (
                    <div className="comments-wrapper mb2" key={video._id}>
                        ...
                        ? video.comments.length > 0
                          ? video.comments.map((comment) => (
                              <CommentItem
                                key={comment._id}
                                comment={comment}
                                tutorialId={this.props.tutorial._id}
                                videoId={video._id}
